...
<div class="form">
	...
	<table style="margin-left: auto; margin-right: auto;">
		...
		<tr>
			<th colspan="4" height="30">Content</th>
		</tr>
		<tr>
	...
	<c:if test="${sessionScope.userId == content.userId}">
		...
		<input type="button" value="Delete" id="btn" onclick="deleteContent();">
	</c:if>
			...
			<c:forEach items="${requestScope.reply}" var="reply">
				<div id="replyList">
					...
					<c:if test="${sessionScope.userId == reply.replyWriter}">
						&emsp;
						<input type="button" value="Update" id="replyBtn" onclick="location.href='${pageContext.request.contextPath}/updateReply.do?boardNo=${content.boardNo}&&replyNo=${reply.replyNo}'">
						<input type="button" value="Delete" id="replyBtn" onclick="location.href='${pageContext.request.contextPath}/deleteReply.do?boardNo=${content.boardNo}&&replyNo=${reply.replyNo}'">
					</c:if>
					<br><br>
					${reply.replyContent}
				</div>
...
<script>		
		function deleteContent(){
			alert("To Do Item has been successfully deleted.");
